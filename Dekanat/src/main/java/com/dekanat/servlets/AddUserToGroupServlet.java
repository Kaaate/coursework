...
import com.dekanat.services.IUserService;
...
public class AddUserToGroupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        groupService.addUser(Integer.parseInt(request.getParameter("id")),g);
        context.setAttribute("free", userService.filterUsersWithoutGroup());
